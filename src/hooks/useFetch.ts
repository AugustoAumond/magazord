...
import fetcher, { getUser, getAllRepositories, getUserStarred,  getFilterRepositories, getCommits, getPopular, getSearchUser, getPopularUsers } from "../service/actions.ts";
...
export const useSearchUser = (search: string) => useSWR(search ? getSearchUser(search) : null, fetcher);
export const useMostPopularUsers = () => useSWR(getPopularUsers, fetcher);
