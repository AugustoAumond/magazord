                ...
                <div className="flex items-center w-full justify-between max-[500px]:flex-col gap-5">
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div className="flex items-center gap-3 p-1.5 b-2 bg-gradient-to-r from-[#0056A6] to-[#0587FF] rounded-2xl">
                            <ChevronLeft  onClick={() => setPageNumber(pageNumber <= 1 ? 1 : pageNumber - 1)} size={20} color="white" className="cursor-pointer"/>
                            <span className="text-white text-sm cursor-pointer">{pageNumber}</span>
                            <ChevronRight onClick={() => setPageNumber(pageNumber + 1)} size={20} color="white" className="cursor-pointer"/>
                        </div>
